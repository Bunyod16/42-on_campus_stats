...
export default function CadetPiscineRatio(props: TPropsType) {
    ...
    return (
        <Card ref={cardRef} className="">
            <CardTitle>
                <span className="h1-cadets">Cadets </span> to <span className="h1-piscine">Pisciners </span> Ratio
                {` ( ${students?.cadets ? students?.cadets : 0} : ${students?.pisciners ? students?.pisciners : 0} )`}
            </CardTitle>
            {students ? (
